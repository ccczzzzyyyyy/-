...
template <> constexpr inline auto GameView::qt_create_metaobjectdata<qt_meta_tag_ZN8GameViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'towerClicked'
        QtMocHelpers::SignalData<void(Tower *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'placementCancelled'
        QtMocHelpers::SignalData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setPlacementMode'
        QtMocHelpers::SlotData<void(TowerKind)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Slot 'clearPlacementMode'
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->towerClicked((*reinterpret_cast<std::add_pointer_t<Tower*>>(_a[1]))); break;
        case 1: _t->placementCancelled(); break;
        case 2: _t->setPlacementMode((*reinterpret_cast<std::add_pointer_t<TowerKind>>(_a[1]))); break;
        case 3: _t->clearPlacementMode(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameView::*)(Tower * )>(_a, &GameView::towerClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameView::*)()>(_a, &GameView::placementCancelled, 1))
            return;
    }
}
...
// SIGNAL 0
void GameView::towerClicked(Tower * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void GameView::placementCancelled()
{
